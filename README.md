...
* **Keep folder structure for recordings**: If disabled create a virtual structure grouping recordings with the same name into folders. If enabled use the real path on the device to dictate the structure instead.
