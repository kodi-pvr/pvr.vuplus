...
namespace enigma2
{
  ...
  private:   
    ...
    bool GetInitialEPGForGroup(enigma2::data::ChannelGroupPtr group);
    PVR_ERROR GetInitialEPGForChannel(ADDON_HANDLE handle, const enigma2::data::ChannelPtr channel, time_t iStart, time_t iEnd);
